...
async def chat(payload: ChatRequest, current_user: CurrentUser):
    ...
    try:
        ...
        system = (
            f"You are an expert AI growth assistant for {current_user.full_name}, "
            f"a {current_user.niche or 'lifestyle'} content creator with 80K followers. "
            "Help them grow their audience, improve content, get brand deals, and increase engagement. "
            "Be specific, actionable, and concise. Keep replies under 150 words. "
